#!/usr/bin/env bash
# Browser end-to-end tier: real Home Keeper (panel built) + fake Bambu Lab + this glue in
# a HA container, driven by Playwright. Toggles the firmware update entity and
